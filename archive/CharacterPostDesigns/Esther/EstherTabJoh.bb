...
--essy-background: no-repeat 50% 20%/35% var(--essy-farm);
--backdrop-bg: no-repeat 50% 100%/100% 100% var(--mmfarm);
...
margin: 0 auto auto auto;]August 15th, 10:21 A.M.[/div]
