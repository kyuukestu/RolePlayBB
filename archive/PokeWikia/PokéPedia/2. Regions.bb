			...
			position: relative; top: var(--body-top);]
				...
				font-family: Geologica;]
                    ...
                    max-width: 90%; margin: var(--grid-c-m); padding: var(--grid-p);]
                        ...
                        z-index: 5;] 
                            [div=/*NOTE - GoTo/Anchor Link */
                            box-sizing: border-box; grid-area: content; z-index: 3; pointer-events: auto; display: flex; align-items: center;]
                                 [a=s2p1] Indigo [/a] 
                            [/div]
                            [div=/*NOTE -  S1.0 Link Styled */
                            box-sizing: border-box; grid-area: content; z-index: 4; pointer-events: none; color: #fff; display: flex; align-items: center;]
                                 Indigo
                            [/div]
                        [/div]
						
                        [div=/*ANCHOR - Indigo Content */
                        margin: var(--grid-c-m); padding: var(--grid-p);]
                        Indigo is the name given to the unified regions of Kanto & Johto. Brought together in decades past by the Kanto-Johto War, Indigo is peculiar exercise in governance as the Kanto-led super-region still allows Johto to exist in a nearly fully-autonomous manner. 
                        [/div]
                        
                        [div=/*ANCHOR - Indigo League */
                        margin: var(--grid-c-m); padding: var(--grid-p);]
                        The Indigo League is the largest league in the world, spanning two regions and 16 Gyms.
                        
                        The League culminates in the Indigo Conference.
                        [/div]
