...
[div=/*ANCHOR - Location */
box-sizing: border-box; font-size: var(--fs-header); margin: auto; padding-left: 50px;] Contest Hall [div=box-sizing: border-box; font-size: var(--fs-mini);] Exeggutor Beach [Exeggutor Island], Alola[/div][/div]

[div=/*ANCHOR - Date/Time & Mention/Interactions */ 
box-sizing: border-box; font-size: var(--fs-mini); margin: -15px 0 20px 0; padding-left: 55px;]August, 11[div=box-sizing: border-box; font-variant-position: super; display: inline;]th[/div] | 9:00 a.m. 
Interaction(s):  
Mention(s): Laurie[/div]
