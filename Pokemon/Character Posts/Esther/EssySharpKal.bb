...
--essy-img: no-repeat 50% 0%/165% url(https://imgur.com/v5nu6kp.png);
...
/*ANCHOR - La Bamba */
--BamImg: url(https://play.pokemonshowdown.com/sprites/gen5ani/shellos-west.gif);
--BamPrimType: #9DB7F5;
--BamSecType: #4A66AB;
...
aspect-ratio: 1; width: 95%; min-width: 20px; border: 2px solid #b71c1c; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.4); background: var(--essy-img); margin: auto; position: relative;][div=position: absolute; bottom: -45px; width: 100%; height: fit-content; display: flex; justify-content: center; flex-flow: column nowrap; text-align: center;][fa]fa fa-arrow-down[/fa][div=box-sizing: border-box]Scroll[/div][/div][/div] 
