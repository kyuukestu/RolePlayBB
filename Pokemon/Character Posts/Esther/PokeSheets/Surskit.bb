...
--essy-img: no-repeat 50% 0%/cover url(https://archives.bulbagarden.net/media/upload/thumb/c/c4/0283Surskit.png/500px-0283Surskit.png);
...
[div=display: flex; margin-bottom: 12px; background: var(--summary-bg); padding: 10px 20px; border: 1px solid #b71c1c; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);  color: var(--accent-c);] 
    [fa]fa fa-map-location-dot fa-2x[/fa] 
...
[div=display: flex; margin-bottom: 12px; background: var(--summary-bg); padding: 10px 20px; border: 1px solid #b71c1c; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);  color: var(--accent-c);] 
    ...
    [/div] 
[div=display: flex; margin-bottom: 15px; background: var(--summary-bg); padding: 10px 20px; border: 1px solid #b71c1c; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5);  color: var(--accent-c);] 
    [fa]fa fa-user-group fa-2x[/fa] 
