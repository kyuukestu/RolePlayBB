[comment][font=Dongle][font=Iceberg]:][/font][/font][/comment]
...
--text-f: 'Dongle', sans-serif; /* Body text font, change font tag above if you change this */
...
border-image: var(--b-i);
align-items: center;
justify-content: center;][comment] - Inventory Items Go Here - [/comment]
₱3,165
[hr][/hr]
+ ₱25,000 (Sold Curse TR)
+ ₱1,000 (PokeJob July 6th)
- ₱150 (PokeCenter July 6th)
[hr][/hr]
₱29,015
[hr][/hr]
Potion x 2 
