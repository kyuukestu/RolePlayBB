...
box-sizing: border-box;
position: absolute; top: 3%; left: 17.5%;
...
top: 14%; left: -31px;
height: 275px; width: 50px; line-height: 9px;
font-size: var(--icon-size);
background: var(--text-bg); color: var(--text-c);
pointer-events: none; 
border-radius: var(--tab-radius); border: 4px solid var(--s-border-bg);]
[div=box-sizing: border-box;][fa]fa-solid fa-paintbrush[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-masks-theater[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-swords[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-bow-arrow[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-user-group[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-horse-head[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-chess-rook[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-crown[/fa][/div]
[div=box-sizing: border-box;][fa]fa-solid fa-champagne-glasses[/fa][/div]
...
[*] $2,500
[/list][/div]
MVP (One from each Side):
[div=white-space: collapse;][List=1]
[*] Life Orb
[*] Water OR Ground Type TR
[/list][/div]
Honorable Mentions (three from each Side):
[div=white-space: collapse;][List=1]
[*] Water OR Ground Type TR
[/list][/div]
[div=font-size: var(--fs-header); font-family: var(--header-font); font-weight: bold; text-align: center;]Participants[/div]
