...
/* Character Image */
--char-img: url(https://media.discordapp.net/attachments/1199283935683813386/1200788576753954896/Draven2.jpg);
...
/* Pokémon Team Data */
--poke-1-img: url(https://play.pokemonshowdown.com/sprites/gen5ani/hoothoot.gif);
--poke-1-prim-type-color: #C6C6A7;
--poke-1-sec-type-color: #938BA2;
