...
/* Character Image */
--char-img: url(https://media.discordapp.net/attachments/1293416407618424923/1293416830542675979/Riley.jpg?ex=6707f48a&is=6706a30a&hm=fa6246866ab8b84c6dd387f9f6cba4231b291d50b1112ed6708d2afaa90de14d&=&format=webp&width=746&height=1121);
...
/* Pokémon Team Data */
--poke-1-img: url(https://play.pokemonshowdown.com/sprites/gen5ani/nidoranm.gif);
--poke-1-prim-type-color: #B884DD;
--poke-1-sec-type-color: #9141CB;
...
justify-content: center;]
    ...
    [div=background-image: var(--poke-1-img); background-size: 85% 85%; background-color: var(--poke-1-prim-type-color); background-position: 5px center 5px; border: 2px solid var(--poke-1-sec-type-color); border-radius: 50px; width: var(--d); height: var(--d); box-sizing: border-box; margin: 2%; display: flex; background-repeat: no-repeat;]
        ...
        [div=background-image: var(--male); background-size: 85% 85%; background-color: #faebd7; background-position: center; border: 1px solid #000; border-radius: 50px; width: calc(var(--d)/3); height: calc(var(--d)/3); box-sizing: border-box; position: relative; top: calc(0.65*var(--d)); right: 5px;][/div]
