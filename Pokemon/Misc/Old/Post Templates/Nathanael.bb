...
/* Pokémon Team Data */
--poke-1-img: url(https://www.smogon.com/forums/attachments/570_1-png.450202/);
--poke-1-prim-type-color: #C6C6A7;
--poke-1-sec-type-color: #493963;
...
--item-1-img: url(https://media.discordapp.net/attachments/191374162978144257/1200291569874518087/MDBag_Red_Bow_TDS_Sprite.png);


/* Accent colours */
--c-1: #bbbd90; /* Header Text Colour */
--c-2: #E64A45; /* Line colour */
--c-3: #828282; /* Body background colour */
--d-color: #ff8e8a; /* Dialogue colour */
...
line-height: 1.2;][comment] -- Character Location --[/comment] PokéMart, Fight Area – Battle Zone 
[/div]
...
justify-content: center;]
    ...
    [div=background-image: var(--poke-1-img); background-size: 125% 125%; background-color: var(--poke-1-prim-type-color); background-position: center; border: 2px solid var(--poke-1-sec-type-color); border-radius: 50px; width: var(--d); height: var(--d); box-sizing: border-box; margin: 2%; display: flex;]
    ...
    [div=background-image: var(--poke-2-img); background-size: 95% 95%; background-color: var(--poke-2-prim-type-color); background-position: center; border: 2px solid var(--poke-2-sec-type-color); border-radius: 50px; width: var(--d); height: var(--d); box-sizing: border-box; margin: 2%;][/div]
...
line-height: 1.2;][comment] Character Time / Date [/comment] 9:25 a.m. – July 1st
