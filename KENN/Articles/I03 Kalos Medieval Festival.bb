...
background: var(--spearow-black); color: var(--spearow-tan); font-size: var(--fs-body);
position: relative; font-family: Newsreader;
...
[div=box-sizing: border-box;]Issue #03[/div]
[div=box-sizing: border-box;]DJ Mary[/div]
[div=box-sizing: border-box;]August 4th, XX22[/div][/div][/div]
...
font-family: var(--header-font); font-size: var(--fs-header-ff); height: fit-content; margin: 0 auto;]Related Links:
[/div]
[div=/*ANCHOR - Link List */
box-sizing: border-box;]
[List]
[*] [URL=https://en.wikipedia.org/wiki/French%E2%80%93Breton_War]French-Breton War[/URL]
[*] [URL=https://www.rpnation.com/threads/pokemon-the-rivers-crown-medieval-festival-recruitment.554996/]Kalos Medieval Festival: Online Registration[/URL]
[/List]
[/div]
[/div]
...
font-family: var(--header-font); font-size: var(--fs-header-ff); height: fit-content; margin: 0 auto;]Kalos Medieval Festival: Promo[/div]
...
The renaissance returns to Loire de Fleuve Isle, just off the coast of Cyllage City, from August 4th to August 13th! History, Adventure, and Festivity come alive in a spectacular display of medieval splendor! Experience the sights, sounds, tastes, and feel of ancient Kalos!

This 10-day event provides a space where history buffs, fantasy lovers, and Pokémon fans alike can enjoy a spectacular blend of old-world charm and modern fun!

[div=background: no-repeat center/contain url(https://static.zerochan.net/Carnet.%28Pok%C3%A9mon%29.1024.3503603.webp); border: 2px solid var(--spearow-brown); float: right; aspect-ratio: 1; width: 30%; padding: 10px; box-sizing: border-box;][/div]

The Festival promises a barrage of events:
[List]
[*] An Art Exhibition
...
It's a feast for the senses, sure to satisfy your every delight!
