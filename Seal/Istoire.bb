[comment][font=Merriweather][font=Afacad Flux].[/font][/font][/comment]
[div=box-sizing: border-box; 

--text-f-s: clamp(0.75em, 1.5vw, 1.05em);
--istoire: url(https://i.imgur.com/hiDZviJ.png);
--ist-c: #71D9E2;

margin: 0 3%; font-family: Afacad Flux, Times New Romans; font-size: var(--text-f-s); letter-spacing: 0.5px; text-align: justify;]
[div=box-sizing: border-box;
background: var(--istoire) no-repeat center/100%;
height: clamp(55px, 12em, 225px); aspect-ratio: 1; margin: 2%;
box-shadow: 5px 2px 5px #71D9E2, -5px 2px 5px #000; 
border-radius: 100px; float: left; position: relative;]
[div=font-size: calc(0.9*var(--text-f-s)); text-align: center; letter-spacing: 1px; position: absolute; top: -50px; width: 100%; font-family: Merriweather;]
Îstoire – The Glutton
[/div]
[/div]
...
The Library | Kidem
[border=transparent; font-size: calc(0.67*var(--text-f-s));]Mentions: Bookie, Aricia, Scarlett
| Tags: @lyn. @CrimsonInk [/border]
[/div]
