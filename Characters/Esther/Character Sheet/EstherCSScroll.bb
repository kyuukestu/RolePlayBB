...
[div=box-sizing: border-box;][goto=overview][fa]fa-solid fa-house[/fa] Overview[/goto][/div]
[div=box-sizing: border-box;][goto=personality][fa]fa-solid fa-icons[/fa] Personality[/goto][/div]
[div=box-sizing: border-box;][goto=history][fa]fa-solid fa-pen-nib[/fa] History/Backstory[/goto][/div]
[div=box-sizing: border-box;][goto=inventory][fa]fa-solid fa-bag-shopping[/fa] Bag/Inventory[/goto][/div]
...
[div= /* SECTION 1 - Esther */
box-sizing: border-box; padding: var(--tab-padding); overflow: scroll; scrollbar-width: thin; scrollbar-color: var(--accent-c) transparent; margin: auto;
width: var(--tab-width); min-height: var(--tab-height);  line-height: 1;
background-color: var(--tab-bgc); border: var(--tab-border);
display: flex; flex-flow: column nowrap;]
[div=color: var(--highlight-prim); font-size: var(--fs-h1); font-family: var(--h1-font); font-weight: bold; margin: 0 auto; width: 100%; text-align: center;][a=overview]Overview[/a][/div]
[div=
