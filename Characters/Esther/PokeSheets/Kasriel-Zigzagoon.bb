[comment][font=Leckerli One][font=Merienda][font=Bellota][font=Kosugi Maru][font=Special Elite].[/font][/font][/font][/font][/font][/comment]
...
--halay-norm: no-repeat 10% -20%/200% url(https://i.imgur.com/8eonm69.png);
--kasriel-norm: no-repeat -25% 25%/125% url(https://imgur.com/3lmY6Qg.png);

--char-img: var(--kasriel-norm);
...
border: 2px double var(--esther-c); box-shadow: 0 0 8px var(--esther-c); aspect-ratio: 1; width: 80%; max-width: 250px; min-width: 100px; background: var(--char-img); margin: auto;][/div][/div]
