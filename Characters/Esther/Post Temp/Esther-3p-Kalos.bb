...
--current-location: var(--medi-bg);
--current-location-ratio: var(--medi-ratio);
--current-esther: var(--essy-knight);
...
position: absolute; width: auto; height: auto; margin: auto; top: -30px; left: 50%; transform: translateX(-50%);
color: var(--accent-c);]
...
[div=
    ...
    [comment]/*!SECTION */[/comment]
[/div][/div]
[div=/*SECTION - Pokémon Position 8 - Bambi */ display: none;
aspect-ratio: 1; height: var(--poke-cell-height); min-width: var(--poke-cell-width); box-sizing: border-box; scroll-snap-align: center;  line-height: 0; border: var(--cellBorder); border-radius: var(--cellRadius);
padding: var(--poke-padding); flex: var(--poke-flex); margin: auto; position: relative; scroll-snap-align: center;]
[div=/*ANCHOR - Pokeball */
...
border: var(--name-border); background: var(--bg-color);
display: flex; justify-content: center; align-items: center;]
[div=animation: fa-fade 3.5s ease-in-out infinite; display: inline; padding: 0 5px;]8:45[/div] A.M.
[/div]
[div=/*STUB - Date Stamp */
...
[div=scroll-snap-align: center; border-right: 2px solid var(--accent-c); height: 100%; width: auto;
display: flex; justify-content: center; align-items: center; padding: 0 5px;]Vasya (@UnknowingLegion)[/div]
[div=scroll-snap-align: center; border-right: 2px solid var(--accent-c); height: 100%; width: auto;
display: flex; justify-content: center; align-items: center; padding: 0 5px;]Miles (@Merciless Medic)[/div] 
[div=scroll-snap-align: center; border-right: 2px solid var(--accent-c); height: 100%; width: auto;
display: flex; justify-content: center; align-items: center; padding: 0 5px;]Zelda  (@Takumi98)[/div]
[/div]
[div=/*STUB - Text Formatting */
margin: auto; margin: 2.5%; padding: 2.5%;
