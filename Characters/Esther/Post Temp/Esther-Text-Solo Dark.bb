...
--essy-img: url(https://imgur.com/1pcaKHb.png);
--char-img: no-repeat 50% 0%/115% var(--essy-img); 
...
font-size: var(--b-fs); filter: brightness(0.8); opacity: 0.8; padding-left: 5px]@Roxshana[/div][/div]
...
[div=/*ANCHOR - Footer , Date & Time*/
position: relative;
max-height: 10%; width: 100%; font-size: var(--b-fs);]
[div=filter: brightness(0.8); opacity: 0.8;]3:00 PM - 15 August[/div]
