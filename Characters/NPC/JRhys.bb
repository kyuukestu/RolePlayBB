[comment][font=Leckerli One][font=Merienda][font=Science Gothic][font=Kosugi Maru].[/font][/font][/font][/font][/comment]
...
--pokemon-one: url(); 
--char-one-bg: no-repeat 0% 140%/30% var(--char-one);
...
height: 80%; max-width: min(575px, 85vw); 
margin: 0; padding: 10px; position: relative; z-index: 2; flex: 1 1 80%;
border-radius: var(--postBorderRadius); border: 1px solid rgba(255, 255, 255, 0.5);]
[div=/*SECTION - Post Container */
height: 100%; width: 100%; color: #fff; -webkit-backdrop-filter: brightness(0.1); backdrop-filter: brightness(0.1);
...
box-sizing: border-box; font-family: var(--H2-font); font-size: var(--fs-header); margin: 15px auto;]J. Rhys[/div]
